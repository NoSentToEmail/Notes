...
class NotesContract {
    class NotesEntry : BaseColumns {
        ...
        var CREATE_COMMAND = "CREATE TABLE IF NOT EXISTS $TABLE_NAME ($_ID $TYPE_INTEGER PRIMARY KEY AUTOINCREMENT, $COLUMN_TITLE $TYPE_TEXT, $COLUMN_DESCRIPTION $TYPE_TEXT, $COLUMN_DAY_OF_WEEK $TYPE_INTEGER, $COLUMN_PRIORITY $TYPE_INTEGER)"
